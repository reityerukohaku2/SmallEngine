...
private:
    ...
    public:
        ...
        {
            m_subobject = ContainingStateObject.TrackSubobject(Type(), Data());
        }
    protected:
        virtual void* Data() = 0;
        void Init() { m_subobject = nullptr; }
    ...
    {
    public:
        OWNED_HELPER(const SUBOBJECT_HELPER_BASE* pHelper) { m_helper = pHelper; }
        ~OWNED_HELPER() { delete m_helper; }
        const SUBOBJECT_HELPER_BASE* m_helper;
    };
...
public:
    ...
    operator const D3D12_STATE_SUBOBJECT&() const { return *m_subobject; }
...
public:
    ...
    operator const D3D12_STATE_SUBOBJECT&() const { return *m_subobject; }
    operator ID3D12RootSignature*() const { return m_rootSig.Get(); }
private:
    void Init()
    {
        SUBOBJECT_HELPER_BASE::Init();
    ...
    void* Data() { return m_rootSig.GetAddressOf(); }
